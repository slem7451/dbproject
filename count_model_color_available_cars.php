<head>
    <meta charset="UTF-8">
    <title>Кол-во и цвет машин в салоне</title>
</head>
<body>
<?php
$mysql = new mysqli('localhost', 'root', 'root', 'car_shop');
$res = $mysql->query("select count(*) as qty, name, model, color, price, fuel_type, body, engine_capacity, release_date from cars join categories on categories.category_id = cars.category_id join car_names on car_names.name_id = cars.name_id
