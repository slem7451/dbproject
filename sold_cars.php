<head>
    <meta charset="UTF-8">
    <title>Проданные машины</title>
</head>
<body>
<?php
$mysql = new mysqli('localhost', 'root', 'root', 'car_shop');
$res = $mysql->query("select cars.car_id, name, model, price, color, fuel_type, body, engine_capacity, release_date 
from cars join sales 
    on cars.car_id = sales.car_id join categories 
        on categories.category_id = cars.category_id join car_names 
            on car_names.name_id = cars.name_id");
$posts = array();
